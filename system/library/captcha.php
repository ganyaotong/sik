...
class Captcha {
	...
	function showImage() {
        ...
        $scolor = imagecolorallocate($this->img,mt_rand(200,255),mt_rand(200,255),mt_rand(200,255)); 
        ...
        imagestring($image,mt_rand(1,5),mt_rand(0,$width),mt_rand(0,$height),'*',$scolor);
        imagestring($image,mt_rand(1,5),mt_rand(0,$width),mt_rand(0,$height),'*',$scolor);
        imagestring($image,mt_rand(1,5),mt_rand(0,$width),mt_rand(0,$height),'*',$scolor);
        imagestring($image,mt_rand(1,5),mt_rand(0,$width),mt_rand(0,$height),'*',$scolor);
        imagestring($image,mt_rand(1,5),mt_rand(0,$width),mt_rand(0,$height),'*',$scolor);
