...
/* Enable use of floated navbar text */
.keymanager{height: 50px !important;}
.keymanager label{margin-right: 1em; width: 100%; display: unset; margin-bottom: unset;}
.keymanager a{top: -2em; position: relative;}
.keymanager span{display: block;}
}
#wrapper,#wrapper1 {
/* position: absolute; */
z-index: 1;
...
.keymanager .keyid{display: none;}
.keymanager .groupid{display: none;};
.keymanager .keylabel{display: none;}
.keymanager .keycontent{display: none;}
.keymanager .keySubdes{display: none;}
.my-edit{float: right;}
.modal-body{
margin: 1em;
}
                        ...
                        <div id="scroller">
                            <ul>
                                ...
                                <li class="keymanager"
                                    ...
                                    data-keylabel="<?php echo  $key['keylabel']; ?>" data-keycontent="<?php echo  $key['keycontent']; ?>" data-keysubdes="<?php echo  $key['keySubdes']; ?>">
                                    <label><strong><?php echo $key['keylabel']; ?></strong></label>
                                    <span class="pull-right"><?php echo $key['keySubdes']; ?></span>
                                    <a onclick="editkey(this);" class="btn pull-right btn-primary my-edit">编辑</a>
                                </li>
                                <?php }?>
...
function editkey(a){
var keyid = $(a).parents(".keymanager").data("keyid");
var groupid = $(a).parents(".keymanager").data("groupid");
var keylabel = $(a).parents(".keymanager").data("keylabel");
var keycontent = $(a).parents(".keymanager").data("keycontent");
var keysubdes = $(a).parents(".keymanager").data("keysubdes");
