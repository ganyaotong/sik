...
<head>
    ...
    <!-- Le styles -->
    <link href="//lib.sinaapp.com/js/bootstrap/2.3.2/css/bootstrap.min.css" rel="stylesheet">
    <style type="text/css">
      body {
        padding-top: 40px;
        padding-bottom: 40px;
    ...
    <link href="//lib.sinaapp.com/js/bootstrap/2.3.2/css/bootstrap-responsive.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin"  action="<?php echo $action ?>" method="post">
            ...
            <input type="text" class="input-block-level" placeholder="Email address" name="emailphone">
            <input type="password" class="input-block-level" placeholder="Password" name="password">
            <input type="password" class="input-block-level" placeholder="Device" name="device">
            <button class="btn btn-large btn-primary" type="submit">登入</button>
            <p class="span4 text-right">需要账户至电脑签约</p>
        </form>
